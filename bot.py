...
model = genai.GenerativeModel("gemini-1.5-flash")  # ✅ Correct AI Studio model
...
def main():
    ...
    webhook_url = f"https://your-render-app.onrender.com/{TELEGRAM_BOT_TOKEN}"  # 👈 Replace with your actual Render URL
